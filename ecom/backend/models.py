...
class MenuList(models.Model):
    ...
    menu_url= models.CharField(max_length=250,unique=True,db_index=True)
...
class ProductMainCategory(models.Model):
    ...
    cat_slug      = models.SlugField(max_length=150, unique=True, blank=True, null=True)
...
class Product(models.Model):
    ...
    discount_percentage= models.PositiveBigIntegerField(default=0,blank=True,null=True)
...
class EmailOTP(models.Model):
    ...
    def is_expired(self):
        return timezone.now() > self.created_at + datetime.timedelta(minutes=20)
